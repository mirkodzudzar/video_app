...
class CategoryTreeAdminList extends CategoryTreeAbstract {
  ...
  //     $this->categoryList .= '<li><i class="fa-li fa fa=arrow=right"></i>' . $value['name'] . '<a href="' . $url_edit . '"> ' . 'Edit' . '</a><a onclick="return confirm(\'Are you sure?\');" href="' . $url_delete . '"> ' . 'Delete' . '</a>';
